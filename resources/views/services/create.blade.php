        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add service To The Section</h4>
                </div>
                <div class="card-body">
                    <div class="card-block">
                        
                        
                    <form action="{{ route('services.store') }}" method="POST"class="form-horizontal" novalidate enctype="multipart/form-data">
                              @csrf
